...
# Weight questions with noun keywords... Ex: "Where" should be weighted to all "Where" questions..
# This should reduce lookup time as we won't need to go over every question.
# How should we weight? Could weight in CSV file manually or do an initial sort here on bootup of the bot..
